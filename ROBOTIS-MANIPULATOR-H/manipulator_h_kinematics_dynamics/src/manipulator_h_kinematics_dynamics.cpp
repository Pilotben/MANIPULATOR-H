...
ManipulatorKinematicsDynamics::ManipulatorKinematicsDynamics(TreeSelect tree)
{
  ...
  if (tree == ARM)
  {
    ...
    manipulator_link_data_[1]->name_    = "base";
    manipulator_link_data_[1]->parent_  = 0;
    manipulator_link_data_[1]->sibling_ = -1;
    manipulator_link_data_[1]->child_   = 1;
    manipulator_link_data_[1]->mass_    = 0.3;
    ...
    manipulator_link_data_[1]->center_of_mass_    = robotis_framework::getTransitionXYZ(0.0, 0.0, 0.06);
    ...
    manipulator_link_data_[2]->name_    = "joint1";
    manipulator_link_data_[2]->parent_  = 1;
    manipulator_link_data_[2]->sibling_ = -1;
    manipulator_link_data_[2]->child_   = 2;
    manipulator_link_data_[2]->mass_    = 0.3;
    manipulator_link_data_[2]->relative_position_ = robotis_framework::getTransitionXYZ(0.0, 0.000, 0.126);
    manipulator_link_data_[2]->joint_axis_        = robotis_framework::getTransitionXYZ(0.0, 1.0, 0.0);
    manipulator_link_data_[2]->center_of_mass_    = robotis_framework::getTransitionXYZ(0.0, -0.0003, 0.03);
    ...
    manipulator_link_data_[3]->name_    = "joint2";
    manipulator_link_data_[3]->parent_  = 2;
    manipulator_link_data_[3]->sibling_ = -1;
    manipulator_link_data_[3]->child_   = 3;
    manipulator_link_data_[3]->mass_    = 0,8;
    manipulator_link_data_[3]->relative_position_ = robotis_framework::getTransitionXYZ(0.0000, 0.0, 0.100);
    manipulator_link_data_[3]->joint_axis_        = robotis_framework::getTransitionXYZ(0.0, 1.0, 0.0);
    manipulator_link_data_[3]->center_of_mass_    = robotis_framework::getTransitionXYZ(0.013, -0.003, 0.398);
    ...
    manipulator_link_data_[3]->parent_  = 3;
    manipulator_link_data_[3]->sibling_ = -1;
